...
Go here to view a tutorial for this package: [landpred Tutorial](https://htmlpreview.github.io/?https://github.com/laylaparast/landpred/blob/main/landpred_tutorial.html). We have a Shiny app here: [landpred Shiny App](https://parastlab.shinyapps.io/landpredApp/).
